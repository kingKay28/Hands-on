...
namespace MedicineTestClass
{
    ...
    public class Class1
    {
        ...
        public void Setup()
        {
             ...
             progObj = new Program();
             medicine = progObj.CreateMedicineDetail("medicine_name", "generic_name", "composition", DateTime.Parse("11/12/2025"), 40);
        }
        ...
        public void CartonCountExceptionTest(int medicineStripCount, DateTime launchDate, string retailerAddress)
        {
            try
            {
                CartonDetail c = progObj.CreateCartonDetail(medicineStripCount, launchDate, retailerAddress, this.medicine);
            }
            catch (Exception ex)
            {
                //Assert.Pass(ex.Message.ToString());
        ...
        public void NullCartonDetailsTest(int medicineStripCount, string launchDate, string retailerAddress)
        {
            CartonDetail carton = progObj.CreateCartonDetail(medicineStripCount, DateTime.Parse(launchDate), retailerAddress, null);
