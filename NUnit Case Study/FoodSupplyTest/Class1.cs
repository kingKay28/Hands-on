...
namespace FoodSupplyTest
{
    ...
    public class Class1
    {
        ...
        {
            progObj = new Program();
            food = progObj.CreateFoodDetail("food_name1", 2, DateTime.Parse("2/22/2022"), 50);
        ...
        [Test]
        [TestCase(2, "2/10/2020", "sellerAB", 80)]
        public void SupplyNullFoodTest(int foodItemCount, DateTime requestDate, string sellerName, double packingCharge)
        {
            
                SupplyDetail supply = progObj.CreateSupplyDetail(foodItemCount, requestDate, sellerName, packingCharge, null);
